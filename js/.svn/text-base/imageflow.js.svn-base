...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		onClick:            function() { $('#thumbnail-view').html('<img width="550" src="' + this.url + '" />');$('#thumbnail-view').dialog({ width: 600 }); },   /* Onclick behaviour */
		...
		reflectPath:        'http://localhost/black-storm/',             /* Path to the reflect_.php script */
